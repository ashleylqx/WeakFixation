...
#SBATCH --output=/research/dept2/qxlai/weakfixation4/basemodel_alt_210829_adam_mcg.txt ##Do not use "~" point to your home!
#SBATCH --gres=gpu:4
...
#CUDA_VISIBLE_DEVICES=0,1,2,3 python main_old.py --phase train_cw_alt_alpha --init_model basemodel_210504_sgd --model_name basemodel_alt_210825_adam --train-batch 48 --test-batch 24 --batch-size 24 --lr 1e-5
CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --resume --phase train_cw_alt_alpha --init_model basemodel_210822_sgd_mcg --model_name basemodel_alt_210829_adam_mcg --train-batch 44 --test-batch 20 --batch-size 20 --lr 1e-4