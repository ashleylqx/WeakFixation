...
run = 'hd_gs_A{}_gd_nf4_normT_eb_{}_aug7_a_A4_fdim{}_34_cw_rng{}_sgd_2'.format(n_gaussian, MAX_BNUM, FEATURE_DIM, RN_GROUP) # 1.0
...
def main_Wildcat_WK_hd_compf_map(args):
    ...
    #             break
        ...
        model_name = 'resnet50_wildcat_wk_hd_cbA{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_{}_rf{}_hth{}_ms4_fdim{}_34_cw_rng{}_sgd_2_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one2_224'.format(
