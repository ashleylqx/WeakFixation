...
def main_Wildcat_WK_hd_compf_map(args):
    ...
    #             break
        ...
        # # #
        model_name = 'resnet50_wildcat_wk_hd_cbA{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_{}_0.1_rf{}_hth{}_ms4_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one3_224'.format(
                                        n_gaussian, normf, MAX_BNUM, prior, rf_weight, hth_weight,kmax,kmin,alpha,num_maps,fix_feature, dilate) #_gcn_all
    ...
    # generate maps
        ...
        for e_num in E_NUM:
            ...
            best_model_file = 'resnet50_wildcat_wk_hd_cbA{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_gbvs_0.25_rf{}_hth{}_ms4_fdim{}_34_cw_rng{}_sgd_6_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one2_224_epoch{:02d}'.format(
                n_gaussian, normf, MAX_BNUM, rf_weight, hth_weight, FEATURE_DIM, RN_GROUP, kmax, kmin, alpha,
                num_maps, fix_feature, dilate, e_num)  # _gcn_all
