...
def parse_arguments():
    ...
    parser.add_argument("--batch_size", default=32*torch.cuda.device_count(), #cw 72(26xxx) or larger #56(512) can be larger #52 (1024) # 16 5000M, can up to 32 or 64 for larger dataset
                        type=int, # cw512 *80* ; cw1024 *64*; cw512 one5 *32*
