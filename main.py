...
def main_Wildcat_WK_hd_compf_map(args):
    ...
    # generate maps
        ...
        best_model_file = 'resnet50_wildcat_wk_hd_cbA{}_alt2_{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_2_nips08_rf{}_hth{}_ms_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one2_224_epoch{:02d}'.format(
...
def parse_arguments():
    ...
    parser.add_argument("--batch_size", default=44*torch.cuda.device_count(), # 16 5000M, can up to 32 or 64 for larger dataset
                        type=int,
                        help="""Set batch size""")
