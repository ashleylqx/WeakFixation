...
def main_Wildcat_WK_hd_compf_map(args):
    ...
    # generate maps
        ...
        for e_num in E_NUM:
            ...
            best_model_file = 'resnet101_wildcat_wk_hd_cbA{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_nips08_norn_rf{}_hth{}_ms4_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one3_224_epoch{:02d}'.format(
