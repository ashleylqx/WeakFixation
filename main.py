...
run = 'hd_gs_A{}_gd_nf4_normT_eb_{}_aug7_a_A4_fdim{}_34_cw_one5'.format(n_gaussian, MAX_BNUM, FEATURE_DIM) # 1.0
...
def main_Wildcat_WK_hd_compf_map(args):
    ...
    #             break
        ...
        model_name = 'resnet50_wildcat_wk_hd_cbA{}_compf_cls_att_gd_nf4_norm{}_hb_{}_aug7_{}_rf{}_hth{}_ms4_fdim{}_34_cw_kmax{}_kmin{}_a{}_M{}_f{}_dl{}_one5_true_224'.format(
                                        n_gaussian, normf, MAX_BNUM, prior, rf_weight, hth_weight,FEATURE_DIM,kmax,kmin,alpha,num_maps,fix_feature, dilate) #_gcn_all
...
def parse_arguments():
    ...
    parser.add_argument("--batch_size", default=36*torch.cuda.device_count(), #cw 72(26xxx) or larger #56(512) can be larger #52 (1024) # 16 5000M, can up to 32 or 64 for larger dataset
                        type=int, # cw512 *80* ; cw1024 *64*; cw512 one5 *36*
