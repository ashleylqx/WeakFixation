...
# run = 'hd_gs_A{}_alt2_{}_gd_nf4_normT_eb_{}_aug7_a_A4_fdim{}'.format(n_gaussian, ALPHA, MAX_BNUM, FEATURE_DIM) # 1.0
...
def parse_arguments():
    ...
    parser.add_argument("--batch_size", default=26*torch.cuda.device_count(), #52 # 16 5000M, can up to 32 or 64 for larger dataset
                        type=int,
                        help="""Set batch size""")
